...
public class AggregateTest extends PlanTestBase {
    ...
    @Test
    public void testUnionAgg5() throws Exception {
        String sql = "select SUM(x2) from (select v2 as x1, v3 as x2 from t0 union all select v2, v3 from t0) as q group by x1";
        String plan = getFragmentPlan(sql);
        System.out.println(plan);
    }
