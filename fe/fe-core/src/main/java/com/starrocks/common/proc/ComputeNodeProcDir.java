...
//   https://github.com/apache/incubator-doris/blob/master/fe/fe-core/src/main/java/org/apache/doris/common/proc/ComputeNodeProcDir.java
...
public class ComputeNodeProcDir implements ProcDirInterface {
    ...
    public static List<List<String>> getClusterComputeNodesInfos(String clusterName) {
        ...
        if (!Strings.isNullOrEmpty(clusterName)) {
            ...
            computeNodeIds = cluster.getComputeNodeIdSet();
        } else {
