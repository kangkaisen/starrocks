...
public class ExpressionAnalyzer {
    ...
    public void analyzeIgnoreSlot(Expr expression, AnalyzeState analyzeState, Scope scope) {
        NoSlotVisitor visitor = new NoSlotVisitor(analyzeState, session);
        bottomUpAnalyze(visitor, expression, scope);
    }
    ...
    static class NoSlotVisitor extends Visitor {
        public NoSlotVisitor(AnalyzeState analyzeState, ConnectContext session) {
    ...
    public static void analyzeExpressionIgnoreSlot(Expr expression) {
        ExpressionAnalyzer expressionAnalyzer = new ExpressionAnalyzer(ConnectContext.get());
